...
export const ui = {
  de: {
    ...
    'common.imagepending': 'Bild folgt',
    'weddings.gallery.arch': 'Blumenbogen für die freie Trauung',
    'weddings.gallery.table': 'Tischgestaltung im Saal',
    'video.play': 'Video abspielen',
    'video.pause': 'Video anhalten',
    'video.atelier.name': 'Im Atelier: So entsteht ein Strauß',
    'video.atelier.desc': 'Am Werktisch: Blumen werden sortiert, entlaubt und von Hand zu Sträußen gebunden.',
    'video.grundkurs.name': 'Grundkurs: Strauß binden',
    'video.grundkurs.desc': 'Am Ende eines Kurses — die fertig gebundenen Sträuße der Teilnehmerinnen.',
    ...
    'build.flowers.own.placeholder': 'z. B. Wicken, Mohn, Flieder — schreiben Sie es einfach hin',
    ...
    'build.mood.light.desc': 'Weiß, Creme, Puder, Blassrosa — ruhig und licht. Der Klassiker für Geburt, Dank und Genesung.',
    'build.mood.bright.desc': 'Pink, Orange, Gelb, Koralle nebeneinander — laut und fröhlich. Für Geburtstage und gute Nachrichten.',
    'build.mood.dark.desc': 'Burgund, Aubergine, Tiefrot, dunkles Lila — schwer und edel. Wirkt abends und in hellen Räumen.',
    'build.mood.mono.desc': 'Alles in einer Farbe, nur in verschiedenen Blumen. Am ruhigsten und am längsten schön.',
    'build.budget': 'Budget',
    'build.budget.hint':
    ...
    'build.contact': 'Ihre Kontaktdaten',
    ...
    'build.send': 'Bestellung abschicken',
    'build.send.hint': 'Ihre Angaben werden mitgenommen. Ich prüfe die Verfügbarkeit für Ihren Termin und bestätige verbindlich — erst danach wird bezahlt.',
  ...
  uk: {
    ...
    'common.imagepending': 'Фото буде',
    'weddings.gallery.arch': 'Квіткова арка для виїзної церемонії',
    'weddings.gallery.table': 'Оформлення столу в залі',
    'video.play': 'Відтворити відео',
    'video.pause': 'Зупинити відео',
    'video.atelier.name': 'В ательє: як народжується букет',
    'video.atelier.desc': 'За робочим столом: квіти сортують, очищають від листя і збирають у букети вручну.',
    'video.grundkurs.name': 'Базовий курс: збирання букета',
    'video.grundkurs.desc': 'Наприкінці заняття — готові букети учасниць.',
    ...
    'build.flowers.own.placeholder': 'напр. запашний горошок, мак, бузок — просто напишіть',
    ...
    'build.mood.light.desc': 'Білий, кремовий, пудровий, блідо-рожевий — спокійно і світло. Класика для народження, подяки й одужання.',
    'build.mood.bright.desc': 'Рожевий, помаранчевий, жовтий, кораловий поруч — гучно й весело. Для днів народження та добрих новин.',
    'build.mood.dark.desc': 'Бордо, баклажан, темно-червоний, темний бузковий — глибоко й вишукано. Гарно ввечері та у світлих кімнатах.',
    'build.mood.mono.desc': 'Усе в одному кольорі, лише різні квіти. Найспокійніше і найдовше гарне.',
    'build.budget': 'Бюджет',
    'build.budget.hint':
      'Бюджет залежить від розміру — менші щаблі приховуються, щойно вони перестають покривати обраний розмір.',
    'build.contact': 'Ваші контактні дані',
    'build.note': 'Примітка',
    ...
    'build.send': 'Надіслати замовлення',
    'build.send.hint': 'Ваші дані переносяться. Я перевірю наявність на вашу дату та підтверджу остаточно — оплата вже після цього.',
  ...
  en: {
    ...
    'common.imagepending': 'Photo to come',
    'weddings.gallery.arch': 'Floral arch for an outdoor ceremony',
    'weddings.gallery.table': 'Table design in the hall',
    'video.play': 'Play video',
    'video.pause': 'Pause video',
    'video.atelier.name': 'In the atelier: how a bouquet is made',
    'video.atelier.desc': 'At the workbench: flowers are sorted, stripped of leaves and tied into bouquets by hand.',
    'video.grundkurs.name': 'Basics: tying a bouquet',
    'video.grundkurs.desc': 'At the end of a class — the bouquets the participants have tied.',
    // — Three ways to order —
    ...
    'build.flowers.own.placeholder': 'e.g. sweet peas, poppies, lilac — just write it down',
    ...
    'build.mood.light.desc': 'White, cream, powder, pale pink — calm and light. The classic for a birth, a thank you, a recovery.',
    'build.mood.bright.desc': 'Pink, orange, yellow, coral side by side — loud and cheerful. For birthdays and good news.',
    'build.mood.dark.desc': 'Burgundy, aubergine, deep red, dark purple — rich and formal. Works in the evening and in bright rooms.',
    'build.mood.mono.desc': 'All one colour, just different flowers. The calmest, and it stays beautiful longest.',
    'build.budget': 'Budget',
    'build.budget.hint':
      'The budget follows the size — smaller steps are hidden once they no longer cover the size you picked.',
    'build.contact': 'Your contact details',
    'build.note': 'Note',
    ...
    'build.send': 'Send the order',
    'build.send.hint': 'Your details come along. I check availability for your date and confirm bindingly — payment comes after that.',
  ...
  ru: {
    ...
    'common.imagepending': 'Фото будет',
    'weddings.gallery.arch': 'Цветочная арка для выездной церемонии',
    'weddings.gallery.table': 'Оформление стола в зале',
    'video.play': 'Воспроизвести видео',
    'video.pause': 'Остановить видео',
    'video.atelier.name': 'В ателье: как рождается букет',
    'video.atelier.desc': 'За рабочим столом: цветы сортируют, очищают от листьев и собирают в букеты вручную.',
    'video.grundkurs.name': 'Базовый курс: сборка букета',
    'video.grundkurs.desc': 'В конце занятия — готовые букеты участниц.',
    // — Три пути к заказу —
    ...
    'build.flowers.own.placeholder': 'напр. душистый горошек, мак, сирень — просто напишите',
    ...
    'build.mood.light.desc': 'Белый, кремовый, пудровый, бледно-розовый — спокойно и светло. Классика для рождения, благодарности и выздоровления.',
    'build.mood.bright.desc': 'Розовый, оранжевый, жёлтый, коралловый рядом — громко и весело. Для дней рождения и хороших новостей.',
    'build.mood.dark.desc': 'Бордо, баклажан, тёмно-красный, тёмно-лиловый — глубоко и благородно. Хорош вечером и в светлых комнатах.',
    'build.mood.mono.desc': 'Всё в одном цвете, только разные цветы. Самый спокойный и дольше всех красивый.',
    'build.budget': 'Бюджет',
    'build.budget.hint':
      'Бюджет зависит от размера — меньшие ступени скрываются, как только их не хватает для выбранного размера.',
    'build.contact': 'Ваши контактные данные',
    ...
    'build.send': 'Отправить заказ',
    'build.send.hint': 'Ваши данные переносятся. Я проверю наличие на вашу дату и подтвержу окончательно — оплата уже после этого.',
